...
folder = Path(r"C:\Users\jonat\Desktop\AConfig Guides\EIGRP")
raw_texts = []
...
Find 50 EIGRP features in the provided manual and provide the commands for them.
=== CONTEXT SNIPPETS ===
{context_snippets}
"""
...
#for i, cfg in enumerate(configs, start=35):
