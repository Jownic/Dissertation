...
Configure a key chain with name EIGRPKey and the key being random letter and numbers in a range of 6 characters.
On every EIGRP-enabled interface, configure:
ip authentication mode eigrp <AS> md5
ip authentication key-chain eigrp <AS> EIGRPKey
