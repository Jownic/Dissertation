...
folder = Path(r"C:\Users\jonat\Desktop\AConfig Guides\VLANs")
raw_texts = []
...
**Create 20 router configurations**
...
**Output only** the final, completed CLI configuration (no explanations), All VLANS must be put into subinterfaces and **ONLY the interfaces mentioned are to be used**. 
"""
...
out_dir = Path(r"C:\Users\jonat\Desktop\Generation Scripts&Results\VLANs")
