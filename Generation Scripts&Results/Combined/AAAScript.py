...
extensions = [
    "Configure a login banner with the text \"Welcome to my C7200\".",
    ...
    "Apply the authentication method list LOGIN-LIST to line con 0.",
    "Apply the authentication method list LOGIN-LIST to line aux 0.",
    "Apply the authentication method list EXEC-LIST to line vty 0 4.",
...
- **Output only** the final, completed CLI configuration (no explanations), **Create 50 router configurations**
"""
