...
output_dir = r"Z:\Thesis\ErrorInputScripts\EIGRPError\3EIGRP"
os.makedirs(output_dir, exist_ok=True)

def remove_three_eigrp_regex_lines(config_text, n=3):
...
# Process router28 through router33
for i in range(28, 34):
    ...
    modified, removed = remove_three_eigrp_regex_lines(original, n=3)
