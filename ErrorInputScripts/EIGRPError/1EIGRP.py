...
output_dir = r"Z:\Thesis\ErrorInputScripts\EIGRPError\1EIGRP"
os.makedirs(output_dir, exist_ok=True)

def remove_one_eigrp_regex_line(config_text, n=1):
...
# Process router16 through router21
for i in range(16, 22):
    ...
    modified, removed = remove_one_eigrp_regex_line(original, n=1)
