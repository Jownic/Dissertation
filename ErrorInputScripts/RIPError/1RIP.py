...
output_dir = r"Z:\Thesis\ErrorInputScripts\RIPError\1RIP"
os.makedirs(output_dir, exist_ok=True)

def remove_one_rip_regex_line(config_text):
    ...
    selected = random.sample(matching_lines, 1)
...
# Process router52 through router57
for i in range(52, 58):
    ...
    modified, removed = remove_one_rip_regex_line(original)

    with open(output_path, 'w') as f:
        f.write(modified)

    if removed:
        print(f"[Router {i}] ✅ Removed line:")
