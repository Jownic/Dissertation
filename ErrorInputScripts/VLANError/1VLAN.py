...
output_dir = r"Z:\Thesis\ErrorInputScripts\VLANError\1VLAN"
os.makedirs(output_dir, exist_ok=True)

def remove_vlan_lines(config_text, n=1):
...
for i in range(67, 73):  # Example: router67 to router73
    ...
    modified, removed = remove_vlan_lines(original, n=1)
