...
output_dir = r"Z:\Thesis\ErrorInputScripts\VLANError\2VLAN"
os.makedirs(output_dir, exist_ok=True)

def remove_vlan_lines(config_text, n=2):
...
for i in range(73, 79):  # Example: router73 to router79
    ...
    modified, removed = remove_vlan_lines(original, n=2)
